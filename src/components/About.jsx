...
const About = () => {
  return (
    <>
      ...
      >
        I am an aspiring software engineering student passionate about building
        modern, scalable applications. My interests include React, Vite,
        Tailwind CSS, ESLint, and Prettier for clean web development, alongside
        3D visualization with Three.js and React Three Fiber for interactive
        experiences. I am also exploring artificial intelligence, machine
        learning, and game development, aiming to combine creativity with
        technical depth while mastering Git workflows, documentation, and
        deployment practices that showcase long‑term reliability.
      </motion.p>
